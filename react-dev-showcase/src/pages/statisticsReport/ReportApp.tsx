...
const tabData = [
  { id: 'tab1', title: '사용자', content: <User /> },
  { id: 'tab2', title: '콘텐츠', content: <Content /> },
  { id: 'tab3', title: '서비스', content: <Service /> },
  { id: 'tab4', title: '설문', content: <Survey /> },
  { id: 'tab5', title: '광고', content: <Advertisement /> },
  { id: 'tab6', title: '커머스', content: <Commerce /> },
  { id: 'tab7', title: '매출액', content: <Income /> },
];
